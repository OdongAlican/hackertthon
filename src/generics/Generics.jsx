...
export const AuthCard = ({
  ...
  <div className="d-flex flex-column align-items-center pl-3" style={{ height: '100vh' }}>
    <div style={{ width: '80%', marginTop: '80px' }}>
      <svg className="" width="40" height="52" viewBox="0 0 40 42" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const InnerRoutesCardTwoSection = ({ element }) => (
  <div className="inner-routes-card-two-innner-section">
    <div className="inner-routes-card-two-left">
      <div className="product-title-and-price">
        ...
        <span className="product-title-and-price-image-first">{element.title}</span>
        ...
        <span className="product-title-and-price-image-second">{element.price}</span>
      </div>
      <div className="product-title-and-price-grid">
        ...
        <div className="date-of-order-product-content">{element.orderDate}</div>
        <div className="date-of-order-product-content">{element.deliveryDate}</div>
